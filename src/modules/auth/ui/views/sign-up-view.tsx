...
const formSchema= z.object({
  name: z.string().min(2, "Name must be at least 2 characters long").max(32, "Name must be at most 32 characters long"),
    ...
    confirmPassword: z.string().min(6, "Confirm Password must be at least 6 characters long").max(32, "Confirm Password must be at most 32 characters long"),
...
<div className="grid grid-cols-2 gap-4">
 ...
 disabled={pending} variant="outline" type="button" >
  ...
  <Button onClick={()=>onsocial("github")} disabled={pending} variant="outline" type="button"  >
  <FaGithub/>
  </Button>
</div>
